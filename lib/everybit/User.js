...
Profile = pineapple.utils.inherit(everybit.EverybitObject, function Profile(fields) {
  this.super(this, false);
  this.define(fields);
});

User = pineapple.utils.inherit(everybit.EverybitObject, function User(uuid) {
  var self  = this, error
